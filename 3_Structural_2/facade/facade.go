...
//t- here we are hiding the complexity of getting the weather
...
//t- here we are hiding the complexity of getting the weather with this simple method by just passing country name, code etc.
